...
public class ValuationDatesOnlyExistsValidator implements ValidatorWithArg<ValuationDates, Set<String>> {
	...
	public <T2 extends ValuationDates> ValidationResult<ValuationDates> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("valuationDatesInitial", ExistenceChecker.isSet((PerformanceValuationDates) o.getValuationDatesInitial()))
				.put("valuationDatesInterim", ExistenceChecker.isSet((PerformanceValuationDates) o.getValuationDatesInterim()))
				.put("valuationDatesFinal", ExistenceChecker.isSet((PerformanceValuationDates) o.getValuationDatesFinal()))
				.build();

...
public class MarginCallResponseActionValidator implements Validator<MarginCallResponseAction> {
	...
	private List<ComparisonResult> getComparisonResults(MarginCallResponseAction o) {
		return Lists.<ComparisonResult>newArrayList(
				checkCardinality("collateralPositionComponent", (List<? extends CollateralPosition>) o.getCollateralPositionComponent() == null ? 0 : ((List<? extends CollateralPosition>) o.getCollateralPositionComponent()).size(), 1, 0), 

...
@ImplementedBy(CalculationPeriodDatesFpMLIrd16.Default.class)
public interface CalculationPeriodDatesFpMLIrd16 extends Validator<CalculationPeriodDates> {
	...
	class Default implements CalculationPeriodDatesFpMLIrd16 {
	...
	class NoOp implements CalculationPeriodDatesFpMLIrd16 {

...
public class DateRelativeToValuationDatesValidator implements Validator<DateRelativeToValuationDates> {
	...
	private List<ComparisonResult> getComparisonResults(DateRelativeToValuationDates o) {
		return Lists.<ComparisonResult>newArrayList(
				checkCardinality("valuationDatesReference", (List<? extends ReferenceWithMetaPerformanceValuationDates>) o.getValuationDatesReference() == null ? 0 : ((List<? extends ReferenceWithMetaPerformanceValuationDates>) o.getValuationDatesReference()).size(), 1, 0)
			);
	}

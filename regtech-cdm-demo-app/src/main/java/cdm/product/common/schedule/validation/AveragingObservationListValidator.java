...
public class AveragingObservationListValidator implements Validator<AveragingObservationList> {
	...
	private List<ComparisonResult> getComparisonResults(AveragingObservationList o) {
		return Lists.<ComparisonResult>newArrayList(
				checkCardinality("averagingObservation", (List<? extends WeightedAveragingObservation>) o.getAveragingObservation() == null ? 0 : ((List<? extends WeightedAveragingObservation>) o.getAveragingObservation()).size(), 1, 0)
			);
	}

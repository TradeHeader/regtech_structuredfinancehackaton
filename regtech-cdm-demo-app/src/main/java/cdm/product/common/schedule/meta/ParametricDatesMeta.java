...
public class ParametricDatesMeta implements RosettaMetaData<ParametricDates> {
	...
	public List<Validator<? super ParametricDates>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.create(cdm.product.common.schedule.validation.datarule.ParametricDatesParametricDatesChoice.class),
			factory.create(cdm.product.common.schedule.validation.datarule.ParametricDatesDayOfWeekMethod.class)
		);
	}

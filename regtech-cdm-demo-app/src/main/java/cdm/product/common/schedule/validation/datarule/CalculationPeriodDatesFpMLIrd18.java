...
@ImplementedBy(CalculationPeriodDatesFpMLIrd18.Default.class)
public interface CalculationPeriodDatesFpMLIrd18 extends Validator<CalculationPeriodDates> {
	...
	class Default implements CalculationPeriodDatesFpMLIrd18 {
	...
	class NoOp implements CalculationPeriodDatesFpMLIrd18 {

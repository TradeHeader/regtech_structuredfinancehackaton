...
@ImplementedBy(ReferencePoolFpMLCd44OpenUnits.Default.class)
public interface ReferencePoolFpMLCd44OpenUnits extends Validator<ReferencePool> {
	...
	class Default implements ReferencePoolFpMLCd44OpenUnits {
	...
	class NoOp implements ReferencePoolFpMLCd44OpenUnits {

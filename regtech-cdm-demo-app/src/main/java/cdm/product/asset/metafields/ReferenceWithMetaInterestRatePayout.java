 ...
 * @version 1
 */
@RosettaDataType(value="ReferenceWithMetaInterestRatePayout", builder=ReferenceWithMetaInterestRatePayout.ReferenceWithMetaInterestRatePayoutBuilderImpl.class, version="0.0.0")
public interface ReferenceWithMetaInterestRatePayout extends RosettaModelObject, ReferenceWithMeta<InterestRatePayout> {

	ReferenceWithMetaInterestRatePayoutMeta metaData = new ReferenceWithMetaInterestRatePayoutMeta();
	...
	/*********************** Builder Interface  ***********************/
	interface ReferenceWithMetaInterestRatePayoutBuilder extends ReferenceWithMetaInterestRatePayout, RosettaModelObjectBuilder, ReferenceWithMeta.ReferenceWithMetaBuilder<InterestRatePayout> {
		...
		ReferenceWithMetaInterestRatePayout.ReferenceWithMetaInterestRatePayoutBuilder prune();
	}

 ...
 * @version 1
 */
@RosettaDataType(value="ReferenceWithMetaCreditDefaultPayout", builder=ReferenceWithMetaCreditDefaultPayout.ReferenceWithMetaCreditDefaultPayoutBuilderImpl.class, version="0.0.0")
public interface ReferenceWithMetaCreditDefaultPayout extends RosettaModelObject, ReferenceWithMeta<CreditDefaultPayout> {

	ReferenceWithMetaCreditDefaultPayoutMeta metaData = new ReferenceWithMetaCreditDefaultPayoutMeta();
	...
	/*********************** Builder Interface  ***********************/
	interface ReferenceWithMetaCreditDefaultPayoutBuilder extends ReferenceWithMetaCreditDefaultPayout, RosettaModelObjectBuilder, ReferenceWithMeta.ReferenceWithMetaBuilder<CreditDefaultPayout> {
		...
		ReferenceWithMetaCreditDefaultPayout.ReferenceWithMetaCreditDefaultPayoutBuilder prune();
	}

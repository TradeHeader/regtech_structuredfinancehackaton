...
@ImplementedBy(PayoutPaymentDates.Default.class)
public interface PayoutPaymentDates extends Validator<Payout> {
	
	String NAME = "PayoutPaymentDates";
	...
	class Default implements PayoutPaymentDates {
	...
	class NoOp implements PayoutPaymentDates {

...
@ImplementedBy(EarlyTerminationEventFpMLIrd40.Default.class)
public interface EarlyTerminationEventFpMLIrd40 extends Validator<EarlyTerminationEvent> {
	...
	class Default implements EarlyTerminationEventFpMLIrd40 {
	...
	class NoOp implements EarlyTerminationEventFpMLIrd40 {

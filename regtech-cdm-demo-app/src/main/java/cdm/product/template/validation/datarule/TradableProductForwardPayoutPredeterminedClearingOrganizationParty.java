...
public interface TradableProductForwardPayoutPredeterminedClearingOrganizationParty extends Validator<TradableProduct> {
	...
	String DEFINITION = "if product -> contractualProduct -> economicTerms -> payout -> forwardPayout -> settlementTerms -> physicalSettlementTerms -> predeterminedClearingOrganizationParty exists then ancillaryParty -> role contains AncillaryRoleEnum -> PredeterminedClearingOrganizationParty";
